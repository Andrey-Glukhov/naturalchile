...
<div class="container-fluid home-container">
    ...
    <div class="u-columns row" id="customer_login">
        ...
        <div class="col-md-10 col-sm-8 col-8">
            <div class="row">
                <div class="u-column1 login-column col-md-6 col-sm-12 col-12">
                ...
                <div class="u-column2 register-column col-md-6 col-sm-12 col-12">
                    ...
                    <form method="post" class="woocommerce-form woocommerce-form-register register"
                        ...
                        <p class="pass_email">
                            <?php esc_html_e( 'A password will be sent to your email address.', 'woocommerce' ); ?></p>
