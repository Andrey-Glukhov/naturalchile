jQuery(function ($) {
  ...
  // function setRatio() {
  //   var startRatio = 1920 / 1080;
  //   if ($(window).width() / $(window).height() < startRatio) {
  //     $(".home-container>video").css("width", "100%");
  //     $(".home-container>video").css("height", "auto");
  //   } else {
  //     $(".home-container>video").css("height", "100%");
  //     $(".home-container>video").css("width", "auto");
  //   }
  // }
  // setRatio();
...
function setGrid() {
  var vidElement = document.querySelector(".home-container>video");
}
